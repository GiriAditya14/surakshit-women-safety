        ...
        <div className='w-full p-3'>
            <div className='w-full p-1 flex flex-col text-center md:flex-row md:justify-center md:items-center md:gap-2'>
                <div className='w-full p-1 flex items-center justify-center text-center md:w-fit'>
                    <h1 className='text-[#FE7678] font-sans text-4xl font-bold tracking-wide md:text-7xl'>One Mission</h1>
                ...
                <div className='w-full p-1 flex items-center text-center justify-center md:w-fit'>
                    ...
                    <h2 className='text-[#FE7678] font-sans text-4xl font-bold tracking-wide md:text-7xl'>One Platform</h2>
            ...
            <div className='w-full p-1 text-center flex flex-col items-center mt-2 md:flex-row md:w-[95%]'>
                <h1 className='font-[300] mb-2 md:font-[350]'>Surakshit is more than just a website—it's a movement to create safer spaces for women everywhere. Whether you’re an individual or an organization, we offer tailored solutions to ensure your safety, dignity, and voice are always protected.</h1>
            ...
            <div className='w-full p-1 md:flex flex-row items-center'>
                <div className=' relative w-full p-1 mt-3 md:w-[49%]'>
                    ...
                    <img className="w-full object-contain object-center shadow-[0px_0px_14px_1px_#1a202c] rounded-[10%] relative" src="/img6.png" alt="" />
                ...
                <div className=' relative w-full p-1 mt-3 md:w-[49%]'>
                    ...
                    <img className="w-full object-contain object-center shadow-[0px_0px_14px_1px_#1a202c] rounded-[10%] relative" src="/img7.png" alt="" />
            ...
            <div className='w-full p-2 text-center mt-3 flex items-center justify-center flex-col md:h-[60vh]'>
                <h1 className="text-center font-medium text-2xl relative inline-block font-sans md:text-5xl">
                    <span className="relative z-10">It’s not just about technology</span>
                    <span className="absolute left-0 top-1/2 w-[120%] h-0.5 md:h-1 bg-red-400 -translate-x-[10%] md:decoration-4"></span>
                </h1>

                <h1 className='text-center font-medium text-gray-700 text-2xl mt-3 md:text-5xl m-2 md:leading-normal'>It's our commitment <br></br>to safety, support, and change.</h1>
            </div>
