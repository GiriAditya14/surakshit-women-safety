    ...
    <footer className='w-full p-4 bg-black text-white rounded-lg mt-auto'>
      <div className='w-full h-fit'>
        <div className='w-full p-2'>
          <img className='h-8' src="/logof.png" alt="Logo" />
          <h1 className='font-[300] text-[15px] md:text-[20px] md:font-normal md:w-[60%] mt-4'>
            Surakshit is dedicated to redefining women's safety through innovation, empathy, and actionable tools. From personal safety features to organizational compliance, we stand with every woman—always.
          </h1>
        </div>
      </div>
      ...
      <div className='w-full p-1 bg-white text-black rounded-lg flex items-center justify-between flex-col md:flex-row md:p-3 mt-4'>
        ...
        <p className='text-[12px] font-[400] font-sans mt-2 md:mt-0'>Copyright © 2025 SURAKSHIT APP. All rights reserved</p>
      </div>
    </footer>
  )
}
